        ...
        if (estimatedShippingDate) {
            ...
            if (deliveryDateTimestamp < shippingDateTimestamp) {
                this._logger.error(
                    ...
                    `${estimatedShippingDate}. New estimated delivery date is 4 days after shipping date.`,
                );
                estimatedDeliveryDate = new Date(shippingDateTimestamp + 4 * 24 * 60 * 60 * 1000).toUTCString();
            }
        }
